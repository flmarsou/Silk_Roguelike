...
public partial class	Program
{
	...
	private static readonly uint[]	_textures = new uint[14];
	...
	private static unsafe void	OnLoad()
	{
		...
		LoadTexture("assets/debug.png", (uint)TextureID.Debug);
		LoadTexture("assets/debug_green.png", (uint)TextureID.DebugGreen);
